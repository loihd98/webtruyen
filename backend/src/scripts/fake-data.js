    ...
    const stories = await Promise.all([
      ...
      prisma.story.create({
        data: {
          ...
          description:
            "Một câu chuyện phiêu lưu đầy hấp dẫn với những âm thanh sống động.",
      ...
      prisma.story.create({
        data: {
          ...
          description:
            "Một câu chuyện tình yêu lãng mạn với nhạc nền và âm thanh tự nhiên.",
      ...
      prisma.story.create({
        data: {
          ...
          content:
            "Thành phố này luôn tấp nập, nhưng đôi khi trong những khoảnh khắc yên tĩnh...",
          type: "TEXT",
          status: "PUBLISHED",
      ...
      prisma.story.create({
        data: {
          ...
          description:
            "Khám phá những bí ẩn ẩn giấu trong rừng sâu với âm thanh 3D.",
          content:
            "Tiếng lá xào xạc, tiếng chim hót, và những âm thanh bí ẩn khác...",
          type: "AUDIO",
          status: "PUBLISHED",
